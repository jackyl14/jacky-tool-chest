...
export default props => {
  const { environment, labResultArray } = props;
  const {
  ...
  const initialState = {
    $$labResultArrayStore: $$labResultArrayReducerState.merge({labResultArray}),
    $$labResultInputStore: $$labResultInputReducerState,
    $$labResultModalStore: $$labResultModalReducerState,
  };
